...
public class Generic extends SuperTestNG
{
	...
	public static void performAction(String...args) throws Exception
	{
		...
		String objclass="";
		try{
			objclass=objxml.strClass(args[0]);
			switch(objclass)
			{
	...
	public static void  toggleCheckBoxInApp(String strObject,String check)
	{
		try{
	...
	public static void dragAndDrop(String drag, String drop) {
		...
		je.executeScript("arguments[0].scrollIntoView(true);",drag);
